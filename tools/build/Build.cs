...
namespace build
{
    ...
    class Build
    {
        ...
        public void OnExecute(CommandLineApplication app)
        {
            ...
            string solutionFile = "Extensions.Caching.Extras.sln";
            string libraryProject = "src/Extensions.Caching.Extras/Extensions.Caching.Extras.csproj";
            string testProject = "tests/Extensions.Caching.Extras.Tests/Extensions.Caching.Extras.Tests.csproj";
